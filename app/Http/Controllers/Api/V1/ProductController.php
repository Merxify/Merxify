...
class ProductController extends ApiController
{
    ...
    public function store(StoreProductRequest $request): ProductResource|JsonResponse
    {
        ...
        return $this->notAuthorized('You are not authorized to create products');
    }
    ...
    public function update(UpdateProductRequest $request, Product $product): ProductResource|JsonResponse
    {
        ...
        return $this->notAuthorized('You are not authorized to update products');
    }
    ...
    public function destroy(Product $product): JsonResponse
    {
        if ($this->isAble('delete', Product::class)) {
            ...
            return $this->ok('Product has been deleted');
        }

        return $this->notAuthorized('You are not authorized to delete products');
    }
}
